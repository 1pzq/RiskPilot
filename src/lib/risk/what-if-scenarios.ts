...
export const WHAT_IF_SCENARIOS: WhatIfScenario[] = [
  {
    ...
    shortLabel: 'SUI -8%',
    category: 'price',
    summary: 'Reprice direct SUI, SUI-related LP legs, and SUI collateral after a moderate drawdown.',
  ...
  },
  {
    ...
    shortLabel: 'SUI -15%',
    category: 'price',
    summary: 'Stress direct SUI, SUI-related LP legs, and SUI collateral after a deeper drawdown.',
  ...
  },
  {
    ...
    category: 'wallet',
    summary: 'Add an unpriced wallet asset to test no-invented-trade behavior in connected-wallet review.',
  ...
  },
  {
    ...
    shortLabel: 'HF slip',
    category: 'lending',
    summary: 'Lower lending collateral value and health factor to simulate liquidation pressure.',
  ...
  },
  {
    ...
    category: 'policy',
    summary: 'Tighten the Policy budget cap to test whether the planned action is blocked.',
